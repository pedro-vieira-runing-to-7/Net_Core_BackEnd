...
{
    public class NewPessoaCommandHandler
    {
        private readonly IPessoaRepository _PessoaRepository;
        private readonly DomainNotificationHandler _domainNotificationHandler;
        public NewPessoaCommandHandler(IPessoaRepository PessoaRepository, DomainNotificationHandler domainNotificationHandler)
        {
        ...
        public Task<Unit> Handle(NewPessoaCommand command)
        {
            ...
            command.Pessoa.Id = _PessoaRepository.Add(pessoa);
